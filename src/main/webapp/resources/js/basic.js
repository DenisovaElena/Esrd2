$(function() {
    ...
    // Раскрытие и сокрытие полей сформированных документов
    $(document).on('click', '.btnViewDoc', function() {
        $(this).removeClass('btnViewDoc').addClass('btnCloseDoc');
        $(this).html('<i class="fas fa-minus mr-2"></i>Свернуть');
    });
    $(document).on('click', '.btnCloseDoc', function() {
        $(this).removeClass('btnCloseDoc').addClass('btnViewDoc');
        $(this).html('<i class="fas fa-plus mr-2"></i>Развернуть');
    });
