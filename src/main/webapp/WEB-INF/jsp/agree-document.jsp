        ...
        <div class="card mx-auto w-100">
            <div class="card-body">
                <div class="container-fluid">
                    ...
                    <div id="docsChildBlock" class="d-none mb-3 mt-n4">
                        <div class="alert alert-secondary text-center mt-5 mb-2">
                            <div class="btn btn-primary btn-sm rounded px-3 btnViewDoc" data-toggle="collapse" data-target="#docsChild" aria-expanded="false" aria-controls="docsChild">
                                <i class="fas fa-plus mr-2"></i>Развернуть
                            </div>
                            <h5 class="mt-2">Сформированные документы</h5>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="collapse multi-collapse" id="docsChild">
                                    <div class="card card-body">
                                        <table id="dataTable" class="table table-striped table-bordered table-sm table-hover" cellspacing="0" width="100%">
                                            <thead>
                                            <tr>
                                                <th class="th-sm font-weight-bold alert-primary" width="5%">№ п/п</th>
                                                <th class="th-sm font-weight-bold alert-primary" width="15%">Тип документа</th>
                                                <th class="th-sm font-weight-bold alert-primary" width="15%">Проектный номер</th>
                                                <th class="th-sm font-weight-bold alert-primary" width="15%">Дата создания проекта</th>
                                                <th class="th-sm font-weight-bold alert-primary" width="15%">Регистрационный номер</th>
                                                <th class="th-sm font-weight-bold alert-primary" width="15%">Дата регистрации</th>
                                                <th class="th-sm font-weight-bold alert-primary" width="10%">Статус</th>
                    ...
                    <div class="alert alert-secondary text-center mb-3 blockDocumentNew d-none">
                        <div class="btn btn-primary btn-sm rounded px-3 btnCloseNew">
                            <i class="fas fa-minus mr-2"></i>Свернуть
                        </div>
    ...
    $(function() {
        ...
        $.getJSON(docURL, function(data) {
            ...
            if(data.docStatus === 'IN_WORK' || data.docStatus === 'COMPLETED') {
                ...
                $.getJSON('rest/profile/docs/'+id+'/childs', function(data) {
                    if(data.length !== 0) {
                        $('#docsChildBlock').removeClass('d-none');
                        dataTableArray("#dataTable","rest/profile/docs/"+id+"/childs", 4);
